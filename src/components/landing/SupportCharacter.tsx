...
export function SupportCharacter() {
  return (
    <div className="relative mx-auto w-full">
      {/* Outer container with soft circular background */}
        ...
        <div className="relative w-full aspect-square">
          ...
          >
            <defs>
              <style>
                {`
                  /* Whole bot: face left (towards screen-right) + walk 10px */
                  #bot-wrapper {
                  ...
                  /* Turn slightly left and walk 10px right and back */
                  @keyframes walkBody {
            ...
            <g id="bot-wrapper">
              ...
              <rect
                ...
                strokeWidth="6"
              />
              {/* Chat bubble, slightly forward (right side) */}
      ...
      {/* Subtle glow effect */}
      <div className="absolute inset-0 rounded-full bg-gradient-to-br from-amber-200/20 via-amber-200/20 to-sky-200/20 blur-2xl -z-10 animate-pulse-slow" />
    </div>
  );
}
